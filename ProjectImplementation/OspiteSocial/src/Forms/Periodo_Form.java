...
public class Periodo_Form extends javax.swing.JFrame {
    
    private Integer indiceAbitazione;
    
    public Periodo_Form(Integer indiceAbitazione) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        abitazioneSelezionata.inserimentoPeriodo(dataInizio,dataFine);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Periodo_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
